 ...
 * 排班表大屏 API
 *
 * GET /api/schedule/screen?year=2026&month=9
 *   返回大屏所需全部数据：
 *   - employees: 全职/兼职分组（按工号排序）
 *   - records: 所有员工排班记录 { employee_id: { day: { shift, meal_time, am_work_type, pm_work_type } } }
 *   - stats: 所有员工统计 { employee_id: { voiceDays, ... } }
 *   - goals: 所有员工月目标 { employee_id: { workload, ... } }
 *   - screenData: 4区/5区/6区展示数据
 */
